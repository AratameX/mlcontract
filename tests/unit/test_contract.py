...
from mlcontract import Contract, ContractDefinitionError, DType, Feature
...
class TestFeatureValidation:
    ...
    def test_non_numeric_bound(self):
        ...
        assert exc.value.code.code == "MLC007"
    ...
    def test_previous_names_cannot_include_own_name(self):
        ...
        assert exc.value.code.code == "MLC013"
...
class TestContractValidation:
    ...
    def test_invalid_versions_rejected(self, version):
        ...
        assert exc.value.code.code == "MLC004"
    ...
    def test_bad_row_bounds(self, bound, value):
        ...
        assert exc.value.code.code == "MLC014"
    ...
    def test_unsupported_spec_version(self):
        ...
        assert "Upgrade mlcontract" in str(exc.value)
